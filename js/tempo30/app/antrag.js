define('tempo30/app/antrag', [
    ...
    //
], function ($, version, step1dialog, step2dialog, step3dialog, strNfDialog, errorDialog, step4dialog, createWord, step5dialog) {
...
/*	var data={};
    ...
    function step3(data) {
	var dialog=step3dialog(data, step2, step4, strNotFound);
	dialog.open();
	$.ajax({
